...
* The original package name 'com.company.springcloud.config.spring-cloud-config-server' is invalid and this project uses 'com.company.springcloud.config.springcloudconfigserver' instead.
